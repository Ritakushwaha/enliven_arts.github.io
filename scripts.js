...
//]]>
  ...
  <body class="full-screen-preview">
    <div class="preview__header" data-view="ctaHeader" data-item-id="14021721">
  <div class="preview__envato-logo">
    <a class="header-envato_market" href="https://themeforest.net/item/artday-creative-shop-template/14021721">Envato Market</a>
  </div>

  <div id="js-preview__actions" class="preview__actions">
  <div class="preview__action--buy">
    <a class="header-buy-now e-btn--3d -color-primary" href="https://themeforest.net/checkout/from_item/14021721?license=regular&amp;support=bundle_6month">Buy now</a>
  </div>

</div>
</div>
<iframe class="full-screen-preview__frame" src="http://artday.wossthemes.com/" name="preview-frame" frameborder="0" noresize="noresize" data-view="fullScreenPreview" allow="geolocation 'self'; autoplay 'self'">
</iframe>
...
<div id="affiliate-tracker" class="is-hidden" data-view="affiliatesTracker" data-cookiebot-enabled="true"></div>
      ...
      <script src="https://consent.cookiebot.com/uc.js" data-cbid="4a6af4ea-f614-41d8-b0a9-8bb6d7fe4799" async="async" id="Cookiebot" nonce="YTGiiOZzT+C2kdPPQr3+tw=="></script>
...
//<![CDATA[
  ...
  function unenrollFromExperiments() {
    var activeExperimentsConfig = {"globalExperiment":{"id":"Q4KMAh3BQ4qNUNsdMXdprg","loadingCover":true,"variants":["0","1"],"domain":"themeforest.net","variantsWeights":[1,9],"requires":{}},"storefrontCodeCanyon":{"id":"2M3oM6GyShW2TmELAaDKdA","loadingCover":false,"variants":["0","1"],"domain":"themeforest.net","variantsWeights":[1,1],"requires":{"globalExperiment":{"variants":["1"]}}},"storefrontThemeForest":{"id":"Vv3kpgVASu-X4xA3ZHeZcw","loadingCover":false,"variants":["0","1"],"domain":"themeforest.net","variantsWeights":[1,1],"requires":{"globalExperiment":{"variants":["1"]}}}}
    var deletedCookies = [];
    ...
    _.each(activeExperimentsConfig, function(expConfig, name) {
      ...
      if ($.cookie(cookieName) != null && $.cookie(cookieName) != '' && typeof($.cookie(cookieName)) != 'undefined') {
        $.removeCookie(cookieName, { path: '/', domain: '.' + expConfig.domain });
  ...
  function setExperimentEnrollments(activeExperimentsConfig) {
    ...
    (function () {
      ...
      for (var i = 0; i < ACCOUNTS.length; i++) {
        ...
        if (!getCookie('CookieConsent') || consentToExperimentsEnrollmentGiven()) {
          var activeExperimentsConfig = {"globalExperiment":{"id":"Q4KMAh3BQ4qNUNsdMXdprg","loadingCover":true,"variants":["0","1"],"domain":"themeforest.net","variantsWeights":[1,9],"requires":{}},"storefrontCodeCanyon":{"id":"2M3oM6GyShW2TmELAaDKdA","loadingCover":false,"variants":["0","1"],"domain":"themeforest.net","variantsWeights":[1,1],"requires":{"globalExperiment":{"variants":["1"]}}},"storefrontThemeForest":{"id":"Vv3kpgVASu-X4xA3ZHeZcw","loadingCover":false,"variants":["0","1"],"domain":"themeforest.net","variantsWeights":[1,1],"requires":{"globalExperiment":{"variants":["1"]}}}}
          setExperimentEnrollments(activeExperimentsConfig);
        }
...
//<![CDATA[
  ...
  (function () {
    if (typeof newrelic !== 'undefined') {
      ...
      var experiment_data_string = "Q4KMAh3BQ4qNUNsdMXdprg.1!2M3oM6GyShW2TmELAaDKdA.1!Vv3kpgVASu-X4xA3ZHeZcw.0" + "!"
